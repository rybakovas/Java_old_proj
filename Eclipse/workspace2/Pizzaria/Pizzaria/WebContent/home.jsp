	  ...
	  <div class="nav-total">
	      <nav>
		      <ul>
				  ...
				  <li><a href="#artigo4">Login</a></li>
				  <li><a href="#artigo7">Funcionario</a></li>
			  ...
			  <article id="artigo2">
				  <div class="fundo-linha">
					  <div class="artigos" >
 							  ...
 							  <p>Favor Logar Para montar a sua Propria Pizza! </p>
				  ...
				  <div class="fundo-linha">
					  <div class="artigos">
							...
							<div id="contato">
							  ...
							  <p>Somente para Funcionarios</p>
							  </div>
 							<form class="form" action="FLogar">  
								  ...
								  <br>
									<br>
							 <center><a href="#artigo8">Cadastrar</a></center>
		  ...
		  <div class="borda">
			  <article id="artigo8">
				...
				<div id="contato">
							  ...
							  <form class="form" action="FCadastra">  
								<p class="name">   
									  <input type="text" name="name" id="name" />  
									  <label for="name">Nome</label>  
								 </p>  
